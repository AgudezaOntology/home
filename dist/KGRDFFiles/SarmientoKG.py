...
SarmientoGraph.add((agdza.ser, rdf.type, agdza.OntologicalRealm))
SarmientoGraph.add((agdza.parecer, rdf.type, agdza.OntologicalRealm))
SarmientoGraph.add((agdza.OntologicalRealm, owl.subClassOf, agdza.KeyTerm))
